...
export const AdminMenu: menu[] = [
    ...
    { id: 'admin-5', isTitle:false, name:"Localisation", hasChildren:true, children:[
        ...
        { id: 'admin-5-6', isTitle:false, name:"CAPE autorisés", route:'/admin/list-requetes/cape', hasChildren:false },
        { id: 'admin-5-7', isTitle:false, name:"CAPE Inscrits", route:'/admin/list-requetes/garderie', hasChildren:false }
    ] },
