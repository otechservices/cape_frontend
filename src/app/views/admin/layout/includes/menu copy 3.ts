...
export const AdminMenu:menu[]=[
...

    {
        ...
        children:[
            {
                isTitle:false,
                name:"Eléments de fiche de contrôle",
                route:'/admin/cfes',
                hasChildren:false
...
export const DFEAMenu:menu[]=[
    ...
    {
        isTitle:false,
        name:"Dossiers CAPE à inscrire en session",
        route:'/admin/requetes/finished/cape',
        hasChildren:false
    
    },
    {
        isTitle:false,
        name:"Dossiers garderie à inscrire en session",
        route:'/admin/requetes/finished/garderie',
        hasChildren:false
