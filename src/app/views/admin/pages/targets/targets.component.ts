...
export class TargetsComponent implements OnInit {
  ...
  getAll(){
    this.targetService.getAll().subscribe((res:any)=>{
      this.data=res.data
  ...
  store(value:any){
    ...
    this.targetService.store(value).subscribe((res:any)=>{
      this.loading=false
  ...
  update(value:any){
    ...
    this.targetService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  delete(){
    ...
    this.targetService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
        ...
        this.targetService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.getAll()
      },
      (err:any)=>{
