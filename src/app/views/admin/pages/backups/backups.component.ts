...
export class BackupsComponent implements OnInit {
  ...
  constructor(
    private bService:BackupService,
  ...
  getAll(){
    this.bService.getAll().subscribe((res:any)=>{
      this.data=res.data
  ...
  store(){
    this.loading=true
    this.bService.store({}).subscribe((res:any)=>{
      this.loading=false
    ...
    (err:any)=>{
      ...
      console.log(err)
        AppSweetAlert.simpleAlert("error","Sauvegarde",err.error.message)
    })
  }
  update(value:any){
    this.loading=true

    this.bService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  delete(){
    ...
    this.bService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
        ...
        this.bService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.getAll()
      },
      (err:any)=>{
