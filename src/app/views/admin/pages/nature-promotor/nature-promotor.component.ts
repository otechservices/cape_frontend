...
@Component({
  selector: 'app-nature-promotor',
  templateUrl: './nature-promotor.component.html',
  styleUrls: ['./nature-promotor.component.css']
})
export class NaturePromotorComponent implements OnInit {
  ...
  getAll(){
    this.npService.getAll().subscribe((res:any)=>{
      this.data=res.data
  ...
  store(value:any){
    ...
    this.npService.store(value).subscribe((res:any)=>{
      this.loading=false
  ...
  update(value:any){
    ...
    this.npService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  delete(){
    ...
    this.npService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
