...
export class ServiceComponent implements OnInit {
  ...
  store(value:any){
    ...
    this.typeService.store(value).subscribe((res:any)=>{
      this.loading=false
  ...
  update(value:any){
    ...
    this.typeService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
        ...
        this.typeService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.getAll()
      },
      (err:any)=>{
