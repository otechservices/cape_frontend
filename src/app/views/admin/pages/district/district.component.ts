...
export class DistrictComponent implements OnInit {
  ...
  getmunicipalities(){
    this.mService.getAll().subscribe((res:any)=>{
  ...
  store(value:any){
    ...
    this.districtService.store(value).subscribe((res:any)=>{
      this.loading=false
    ...
    (err:any)=>{
      ...
      console.log(err)
        AppSweetAlert.simpleAlert("error","Arrondissement",err.error.message)
    })
  }
  update(value:any){
    this.loading=true

    this.districtService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  delete(){
    ...
    this.districtService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
        ...
        this.districtService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.getAll()
      },
      (err:any)=>{
