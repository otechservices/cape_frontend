...
@Component({
  selector: 'app-type-garderie',
  templateUrl: './type-garderie.component.html',
  styleUrls: ['./type-garderie.component.css']
})
export class TypeGarderieComponent implements OnInit {
  ...
  constructor(
    private typeGarderieService:TypeGarderieService,
  ...
  getAll(){
    this.typeGarderieService.getAll().subscribe((res:any)=>{
      this.data=res.data
  ...
  store(value:any){
    ...
    this.typeGarderieService.store(value).subscribe((res:any)=>{
      this.loading=false
    ...
    (err:any)=>{
      ...
      console.log(err)
        AppSweetAlert.simpleAlert("error","Type Garderie",err.error.message)
    })
  }
  update(value:any){
    this.loading=true

    this.typeGarderieService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  delete(){
    ...
    this.typeGarderieService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
        ...
        this.typeGarderieService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.getAll()
      },
      (err:any)=>{
