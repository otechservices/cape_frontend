...
@Component({
  selector: 'app-control-file-element',
  templateUrl: './control-file-element.component.html',
  styleUrls: ['./control-file-element.component.css']
})
export class ControlFileElementComponent implements OnInit {
  ...
  constructor(
    ...
    private uaService:UniteAdminService,
  ...
  getAll(){
    this.cfeService.getAll().subscribe((res:any)=>{
      this.data=res.data
  ...
  getUAs(){
    this.uaService.getAll().subscribe((res:any)=>{
      this.uas=res.data
    },
    (err:any)=>{
  ...
  store(value:any){
    ...
    this.cfeService.store(value).subscribe((res:any)=>{
      this.loading=false
  ...
  update(value:any){
    ...
    this.cfeService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  delete(){
    ...
    this.cfeService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
        ...
        this.cfeService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.getAll()
      },
      (err:any)=>{
