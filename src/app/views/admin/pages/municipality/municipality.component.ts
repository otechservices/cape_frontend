...
export class MunicipalityComponent implements OnInit {
  ...
  store(value:any){
    ...
    this.municipalityService.store(value).subscribe((res:any)=>{
      this.loading=false
    ...
    (err:any)=>{
      ...
      console.log(err)
        AppSweetAlert.simpleAlert("error","Communes",err.error.message)
    })
  }
  update(value:any){
    this.loading=true

    this.municipalityService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  delete(){
    ...
    this.municipalityService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
        ...
        this.municipalityService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.getAll()
      },
      (err:any)=>{
        console.log(err)
          AppSweetAlert.simpleAlert("error","Commune",err.error.message)
      })
  }
