...
export class MemberComponent implements OnInit {
  ...
  constructor(
    private membreService:MemberServiceService,
  ...
  getAll(){
    this.membreService.getAll().subscribe((res:any)=>{
      this.data=res.data
  ...
  store(value:any){
    ...
    this.membreService.store(value).subscribe((res:any)=>{
      this.loading=false
  ...
  update(value:any){
    ...
    this.membreService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  delete(){
    ...
    this.membreService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
        ...
        this.membreService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.getAll()
      },
      (err:any)=>{
