...
export class TypeInfoComponent implements OnInit {
  ...
  getAll(){
    this.typeInfoService.getAll().subscribe((res:any)=>{
      this.data=res.data
  ...
  store(value:any){
    ...
    this.typeInfoService.store(value).subscribe((res:any)=>{
      this.loading=false
    ...
    (err:any)=>{
      ...
      console.log(err)
        AppSweetAlert.simpleAlert("error","Type Info",err.error.message)
    })
  }
  update(value:any){
    this.loading=true

    this.typeInfoService.update(this.selected_data.id,value).subscribe((res:any)=>{
      this.loading=false
  ...
  delete(){
    ...
    this.typeInfoService.delete(this.selected_data.id).subscribe((res:any)=>{
        this.toastrService.success(res.message)
        this.getAll()
    },
    (err:any)=>{
  ...
  setStatus(value:any){
    ...
    this.toastrService.warning("Opération en cours")
        ...
        this.typeInfoService.setStatus(this.selected_data.id,value).subscribe((res:any)=>{
          this.toastrService.success(res.message)
          this.getAll()
      },
      (err:any)=>{
