...
@Component({
  selector: 'app-update-request-garderie',
  templateUrl: './update-request-garderie.component.html',
  styleUrls: ['./update-request-garderie.component.css']
})
export class UpdateRequestGarderieComponent implements OnInit {
...
nps=[
  ...
  ngOnInit(): void {
    ...
    this.myRequestForm.nature_promotor_id=this.data2.nature_promotor_id
    this.myRequestForm.has_consent=this.data2.has_consent
    ...
    this.data2.requete_type_garderies.forEach((element:any) => {
      this.selectedItems2.push({
        id:element.requete_id,
        itemName:element.type_garderie_id
      })
    });
